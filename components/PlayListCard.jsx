...
const PlayListCard = ({ Playlist }) => {
  ...
  return (
    <div onClick={() => dispatch(fetchPlaylistDetails(Playlist.id, session.accessToken)) } className="flex items-center p-2 space-x-2 space-y-2 h-10 w-36 text-gray-500 cursor-pointer">
