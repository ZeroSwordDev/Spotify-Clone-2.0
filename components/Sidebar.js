...
function Sidebar() {
  return (
    <div className=" flex flex-col justify-between items-center  w-[210px] h-[850px] p-3 bg-black">
      ...
      <div className=" flex flex-col gap-2 items-center  p-3 ">
        ...
        {/* PlayList */}
        <div className=" flex flex-col w-40 h-[400px] p-2 gap-2">
      ...
      {/* PLay  */}
      <div className="flex w-32 h-[30px]">
